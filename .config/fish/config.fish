...
function fish_greeting
	...
	if [ $r -lt 50 ]
		...
		set_color yellow
		echo "  [RustCompiler] <Contributing to Rustc, Episode 4(a) MIR passes, MIR visitors, and a very simple MIR transform https://youtu.be/2If0BOfCy2Q>"
		echo "  [RustCompiler] <Contributing to Rustc, Episode 4(b) Finishing our (unsound, naive) MIR transform https://youtu.be/_Hbfr17OkOs>"
	end

	# urgent, so prompt always
	set_color red
	echo "  [Litheum] <P2P Networking>"
